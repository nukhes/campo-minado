...
System.ConsoleKey key; // variável para capturar input
bool estadoJogo = true; // esta variável controla se o jogo está ativo ou não
bool venceuJogo = false; // variável que seta o resultado final
...
void JogoRefresh() // reseta o jogo
{
	...
	// análise das células para designar o número
	for (int i = 0; i < d; i++)
	{
		for (int ii = 0; ii < d; ii++)
		{
...
void VerificarEstado() // este método ira verificar por perdas ou vitórias
{
